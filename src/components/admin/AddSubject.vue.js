...
function __VLS_template() {
    ...
    __VLS_elementAsFunction(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({ type: ("submit"), ...{ class: ("mr-2 bg-yellow-400 py-2 px-3 rounded text-lg") }, });
    __VLS_elementAsFunction(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({ ...{ onClick: (__VLS_ctx.resetForm) }, type: ("reset"), ...{ class: ("mr-2 bg-gray-800 text-white py-2 px-4 rounded text-lg") }, });
    // @ts-ignore
    [resetForm,];
