    ...
    data() {
        return {
            ...
            teachers: [
                ...
                {
                    subName: "Digital Logic",
                    course: "BSIT",
                    sem: "1st",
                    teacher: "Jhonel",
                },
                { subName: "OOP", course: "BSCS", sem: "1st", teacher: "Abalorio" },
            ],
        };
    },
});
...
function __VLS_template() {
    ...
    // @ts-ignore
    const __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0({ to: ("/AddSubject"), }));
    const __VLS_2 = __VLS_1({ to: ("/AddSubject"), }, ...__VLS_functionalComponentArgsRest(__VLS_1));
    ({}({ to: ("/AddSubject"), }));
    ...
    for (const [teacher, index] of __VLS_getVForSourceType((__VLS_ctx.teachers))) {
