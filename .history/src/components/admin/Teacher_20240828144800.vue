  ...
  data() {
    return {
      ...
      students: [
        ...
        { name: "Bridie Kessler", address: "Butuan City", email: "bridiekessler@gmail.com", username: "bridie", password: "1234brandon" },
        { name: "Ashleigh Langosh", address: "Butuan City", email: "ashleighLangosh@gmail.com", username: "ashleigh",},
      ],
    };
  },
};
