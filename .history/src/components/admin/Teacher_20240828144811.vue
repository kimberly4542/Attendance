<template>
  ...
  <div class="mb-2">
    <ol class="flex text-gray-600 text-sm m-0 p-0">
      ...
      <li class="px-2 font-semibold">Teacher</li>
    </ol>

    <div class="bg-white border-0 shadow-md rounded mt-4 p-3">
      <div class="d-flex justify-between items-center">
        <div class="card-body">
          <span class="card-title text-lg font-semibold">Teacher</span>
        </div>
      ...
      >
        ...
        <tbody class="divide-y divide-gray-200">
          <tr v-for="(teacher, index) in students" :key="index">
            <td
...
export default {
  data() {
    return {
      ...
      selectedSubject3: "",
      students: [
        { name: "Brandon Jacob", address: "Butuan City", email: "brandonjacob@gmail.com", username: "brandon", password: "1234brandon"  },
        { name: "Bridie Kessler", address: "Butuan City", email: "bridiekessler@gmail.com", username: "bridie", password: "1234bridie" },
        { name: "Ashleigh Langosh", address: "Butuan City", email: "ashleighLangosh@gmail.com", username: "ashleigh", password: "1234brandon"},
      ],
    };
  },
};
