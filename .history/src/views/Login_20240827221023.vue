  ...
  >
    <div class="flex w-full max-w-6xl mx-auto">
      ...
      <div class="w-1/2 p-10">
        ...
        <h2 class="text-4xl font-semibold text-customGray">Management System</h2>
        ...
        <p class="mt-4 text-customGray">
          Morbi a bibendum metus. Donec scelerisque sollicitudin enim eu venenatis. Duis tincidunt
          laoreet ex, in pretium orci vestibulum eget.
        </p>
      </div>
